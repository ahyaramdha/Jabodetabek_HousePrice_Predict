...
if page == 'Home':
    ...
    fig = px.scatter_mapbox(df, lat=df['lat'], lon=df['lon'], center={'lat': -6.21462, 'lon': 106.84513}, zoom=9, color='Harga', labels={'Harga': 'Price'},size = df['Ukuran'], size_max = 10, color_continuous_scale=px.colors.sequential.Rainbow, width=720, height=500, hover_name="Kota")
